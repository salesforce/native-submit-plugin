...
incpath=''
incpth='/usr/lib/gcc/aarch64-linux-gnu/9/include /usr/local/include /usr/include/aarch64-linux-gnu /usr/include'
inews=''
...
src='/build/perl-cr0D9j/perl-5.30.0'
ssizetype='ssize_t'
st_ino_sign='1'
st_ino_size='8'
